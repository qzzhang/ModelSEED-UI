...
function($s, $http, config, $rootScope) {
    ...
    $http.get('https://raw.githubusercontent.com/ModelSEED/ModelSEEDTemplates/main/GramPositive_CHANGELOG.md')
         .then(function(res) {
            var gp_text = res.data.trim();
            $s.gramPositive_changelog = converter.makeHtml(gp_text);
         })
    $http.get('https://raw.githubusercontent.com/ModelSEED/ModelSEEDTemplates/main/GramNegative_CHANGELOG.md')
         .then(function(res) {
