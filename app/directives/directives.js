...
.directive('ngTableSubsystem',
    ...
    return {
        ...
        link: function(scope, elem, attrs) {
            ...
            // run through the tree nodes to find ortholog matches in ortho_data
            // looping through the gene's orthologs and matching them with the family tree node names;
            ...
            function getColIdByColKey(col_k) {
                var func_arr = scope.dataClone[0]['Genome'];
